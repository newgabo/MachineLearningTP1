...
original_dataset_url = "E:/GoogleDrive/Maestria_DataMining/Aprendizaje Automatico (Lunes)/TP1/datasets/hotel_bookings - pruebas.csv"
clean_dataset_url = "E:/GoogleDrive/Maestria_DataMining/Aprendizaje Automatico (Lunes)/TP1/datasets/hotel_bookings_clean.csv"
...
booking_dataset.to_csv(clean_dataset_url, sep=',', encoding='utf-8')
